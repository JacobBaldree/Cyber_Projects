...
- _TODO: What aspect of security do load balancers protect? A jumpbox limits the number of machines that can accept connection from outside the virtual network What is the advantage of a jump box?_
