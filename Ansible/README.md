...
![Topology Diagram](Diagrams/Azure_Diagram.jpg)
...
Load balancing ensures that the application will be highly reliable, in addition to restricting accessible to the network.
- _TODO: What aspect of security do load balancers protect? A jumpbox limits the number of machines that can accept connection from outside the virtual network, thus making it more secure. What is the advantage of a jump box?_
